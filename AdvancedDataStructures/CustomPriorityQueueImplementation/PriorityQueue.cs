...
namespace CustomPriorityQueueImplementation
{
    ...
    public class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
    {
        ...
        private IEnumerable<KeyValuePair<TPriority, TValue>> data;
        ...
        public IEnumerable<KeyValuePair<TPriority, TValue>> Data
        {
            get
            {
                return this.data;
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Data provided in PriorityQueue constructor cennot be null. You have to instantiate it first.");
                }
        ...
        public IComparer<TPriority> Comparer
        {
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Comparer cannot be null. You have to initialize it first.");
                }
        ...
        public static PriorityQueue<TPriority, TValue> MergeQueues(PriorityQueue<TPriority, TValue> pq1, PriorityQueue<TPriority, TValue> pq2)
        {
            ...
            {
                throw new ArgumentNullException("PriorityQueues cannot be null.");
            }
        ...
        public bool Remove(KeyValuePair<TPriority, TValue> item)
        {
            ...
            // heapify
            int newPos = this.HeapifyFromBeginningToEnd(elementIdx);
        ...
        private void Insert(TPriority priority, TValue value)
        {
            ...
            this.HeapifyFromBeginningToEnd(this.baseHeap.Count - 1);
        }
